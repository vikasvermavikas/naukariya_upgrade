        ...
        <table style="width: 600px; margin: 0 auto; background-color: #ffffff">
            ...
            <tbody style="padding-left: 20px">
                <tr>
                    ...
                    <h4 style="font-family: Calibri; margin-left: 20px">Hi {{$name}}({{$job_title}}),</h4>
                     <h4 style="font-family: Calibri; margin-left: 20px">Your Password changed successfully.</h4>
                     <p style="font-family: Calibri; margin-left: 20px"> Your New Password - {{$new_pass}}. </p>
