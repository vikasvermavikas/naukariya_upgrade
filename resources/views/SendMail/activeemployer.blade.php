            ...
            <tbody style="padding-left: 20px">
                <tr>
                    ...
                    <h4 style="font-family: Calibri; margin-left: 20px">Hi {{$name}},</h4>
                     <h4 style="font-family: Calibri; margin-left: 20px">Your Account now activated successfully.</h4>
                     <p style="font-family: Calibri; margin-left: 20px"> You can use your credential to login your account. </p>
                     <p style="font-family: Calibri; margin-left: 20px">Credentials already sent to your registration mail. </p>
                      <p style="font-family: Calibri; margin-left: 20px">Kindlly Check it </p>
