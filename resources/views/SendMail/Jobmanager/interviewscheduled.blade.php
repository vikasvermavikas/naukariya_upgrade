        ...
        <table style="width: 600px; margin: 0 auto; background-color: #ffffff">
            ...
            <tbody style="padding-left: 20px">
                <tr>
                    ...
                    <h4 style="font-family: Calibri; margin-left: 20px">Hi {{$name}}({{$job_title}}), and Application Id {{$application_id}}</h4>
                     <h4 style="font-family: Calibri; margin-left: 20px">Interview Acheduled successfully.</h4>
