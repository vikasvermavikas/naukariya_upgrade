...
<div style="width: 100%; background: #e5e5e5;padding: 15px 0;">
    <table style="width: 600px; margin: 0 auto; background-color: #ffffff">
        ...
        <tr>
            ...
            <h4 style="font-family: Calibri; margin-left: 20px">Dear {{$name}},</h4>
            <h4 style="font-family: Calibri; margin-left: 20px">Your OTP Is {{$otp}}.</h4>

        </tr>
        <tr>
            <h4><a href="{{ route('download-agreement') }}">Click here to</a><br>Download Agreement format .</h4>
