        ...
        <table style="width: 600px; margin: 0 auto; background-color: #ffffff">
            ...
            <tbody style="padding-left: 20px">
                <tr>
                    ...
                    <h4 style="font-family: Calibri; margin-left: 20px">Hi {{$company_name}},</h4>
                     <h4 style="font-family: Calibri; margin-left: 20px">Your Company De-activated successfully.</h4>
                     <p style="font-family: Calibri; margin-left: 20px">Please Contact admin for the reason of De-activating account. </p>
