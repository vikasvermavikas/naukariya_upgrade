            ...
            <tbody style="padding-left: 20px">
                <tr>
                    ...
                    <h4 style="font-family: Calibri; margin-left: 20px">Hi {{$name}},</h4>
                     <h4 style="font-family: Calibri; margin-left: 20px">You Shown your interest for job successfully.</h4>
                     
                </tr>
                <tr>
                    <form action="{{ url('edit_candidate_self_registration') }}" method="post">
                        @csrf
