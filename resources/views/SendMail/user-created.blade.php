        ...
        <table style="width: 600px; margin: 0 auto; background-color: #ffffff">
            ...
            <tbody style="padding-left: 20px">
                <tr>
                    ...
                    <h4 style="font-family: Calibri; margin-left: 20px">Hi {{$name}}({{$designation}}),</h4>
                     <h4 style="font-family: Calibri; margin-left: 20px">Your Account Created .</h4>
                     <p style="font-family: Calibri; margin-left: 20px"> Your User Name is your email id </p>
                     <p style="font-family: Calibri; margin-left: 20px"> Your New Password - <b>{{$password}}</b> </p>
