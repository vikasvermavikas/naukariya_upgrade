        ...
        <table style="width: 600px; margin: 0 auto; background-color: #ffffff">
            ...
            <tbody style="padding-left: 20px">
                <tr>
                    ...
                    <h4 style="font-family: Calibri; margin-left: 20px">Hi {{$job_title}},</h4>
                     <h4 style="font-family: Calibri; margin-left: 20px">Package ({{$package_name}}) Now De-activated.</h4>
                     <p>Please contact Admin for the reason of de-activating Package.</p>
                </tr>
                <tr>
