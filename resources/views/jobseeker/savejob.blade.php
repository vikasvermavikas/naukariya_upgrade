                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn w-100" data-toggle="modal" data-target="#myModal{{$loop->iteration}}">
                                    Apply Now
                                </button>
                                ...
                                <div class="modal fade" id="myModal{{$loop->iteration}}">
                                    <div class="modal-dialog modal-dialog-scrollable">
                                        <div class="modal-content">
                                            ...
                                            <form role="form" action={{ route('applyjob', ['id' => $value->id]) }}
                                                method="post">
                                                @csrf
                                                <!-- Modal body -->
                                                <div class="modal-body">
                                                    <div class="form-group row inputBox">
                                                        <div class="col-sm-12">
                                                            <div class="input text">
                                                                <p><strong>Job Title</strong> :- {{ $value->title }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row inputBox">
                                                        <div class="col-sm-12">
                                                            <div class="input text">
                                                                <p><strong> Location</strong> :- {{ $value->job_exp }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="question">
                                                        <p> Do you have relevant experience of this job
                                                            ({{ $value->main_exp."Yr"." - " . $value->max_exp."Yr" }}) </p>
                                                        <fieldset class="mb-3">
                                                            <div class="form-group ask_question">
                                                                <div class="icheck-primary d-inline"><input type="radio"
