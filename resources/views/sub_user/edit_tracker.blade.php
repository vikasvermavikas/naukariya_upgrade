    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 border  h-auto wrapper-profile">
                ...
                <form class="edit_tracker_form" action="{{ route('update_tracker') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="d-none">
                            ...
                            <select name="hometown_state" id="hometown_state" style="outline: none;">
                                ...
                                @foreach ($states as $state)
                                    <option value="{{ $state->states_name }}"
                                        {{ $trackerDetails->hometown_state == $state->states_name || $trackerDetails->hometown_state == $state->id ? 'selected' : '' }}>
