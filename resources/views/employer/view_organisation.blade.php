        ...
        <div class="col-md-12" style="background:#EAEDFF;">
            <div class="row my-3">
                <div class="col-md-6 d-flex justify-content-center">
                    <img src="{{asset('company_logo/'.$company_details->company_logo.'')}}" alt="" class="img-fluid rounded" style="width: 43%">
                </div>
                 <div class="col-md-6">
                    <h3 class="dark-color">Company Details <a href="{{route('employer_edit_profile')}}" title="Edit" data-toggle="tooltip" data-placement="top"><i class="fas fa-edit small"></i></a></h3>
                    <div class="row about-list">
                        ...
                        <div class="col-md-6  my-2">
                            <label>Website:</label>
                            <span> <a href="{{ $company_details->com_email }}" class="text-primary">{{ $company_details->com_email }}</a> </span>
                        </div>
                        <div class="col-md-6  my-2">
                            <label>Contact:</label>
