    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <form action="" method="GET">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('tracker-list') }}" class="btn">Reset</a>
                        </div>
            ...
            <div class="d-flex col-md-12 justify-content-end">
                <a href="{{route('exportTracker')}}" target="_blank" class="btn"><svg xmlns="http://www.w3.org/2000/svg" class="mb-2" viewBox="0 0 512 512"
                        width="20px">
                        <path fill="#FFFFFF"
                                    ...
                                    <div class="col-md-8">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <span
                                                    style="color: #E35E25;">{{ $item->current_ctc ? $item->current_ctc : 'N/A' }}</span>
                                            </div>
                                            <div class="col-md-6">
