                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="count-job mb-35">
                                            <span id="jobcount"> Jobs found {{ count($jobs['job']) }}</span>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="job-tittle job-tittle2">
                                                                                <ul class="d-flex my-2">
                                                                                    <li><span
                                                                                            class="font-weight-bold">Company
                                                                                        </span>
                                                                                        :
                                                                                        {{ $job['company'] }}</li>
                                                                                ...
                                                                                <ul class="d-flex my-2">
                                                                                    <li><span
                                                                                            class="font-weight-bold">Location
                                                                                        </span>:
                                                                                        {{ $job['location'] ? $job['location'] : '' }}
                                                                                    </li>
                                                                                </ul>
                                                                                <ul class="d-flex my-2">
                                                                                    <li> <span class="font-weight-bold">Time
                                                                                            posted
                                                                                        </span> :
                                                                                        {{ $job['list_date'] }}
                                                                                    </li>
