    ...
    <section class="contact-section">
        <div class="container">
            <div class="d-none d-sm-block mb-2 pb-2 card shadow">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14020.409158098062!2d77.210832!3d28.536645!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce1f700000001%3A0x68dca73f09d47c81!2sPrakhar%20Software%20Solutions%20Pvt.%20Ltd.!5e0!3m2!1sen!2sin!4v1718702674922!5m2!1sen!2sin"
                ...
                <div class="col-lg-8 card text-color shadow">
                    <form class="form-contact contact_form p-2 " method="post" id="myForm">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input class="form-control" name="contact_no" id="contact_no" type="text"
                                        ...
                                        onfocus="this.placeholder = ''" oninvalid="this.setCustomValidity('Invalid Contact no.')" onblur="this.placeholder = 'Enter 10 digit Contact Number'"
                                        placeholder="Enter 10 digit Contact Number" oninput="this.setCustomValidity('')" required>
                                    <small class="text-danger" id="contact_no_error"></small>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <textarea class="form-control w-100" name="remarks" id="remarks" cols="30" rows="9"
                        ...
                        <div class="form-group mt-3">
                            <button type="submit" id="submit_contact_form" class="button button-contactForm boxed-btn">Send
                            </button>
