                                     ...
                                     <div class="mt-10 info"></div> --}}
                                        ...
                                        <div class="footer-social d-flex">
                                            <a href="{{ !empty(get_social_links()) ? get_social_links()->facebook_links : '' }}"
                                                title="facebook" data-toggle="tooltip" data-placement="top"><i
                                                    class="fab fa-facebook-f"></i></a>
                                            <a
                                                href="{{ !empty(get_social_links()) ? get_social_links()->twitter_links : '' }}"><svg
                                                    xmlns="http://www.w3.org/2000/svg" class="mb-4 twittericon"
                                                    viewBox="0 0 512 512" width="20" title="twitter"
                                                    data-toggle="tooltip" data-placement="top">
                                                    <path fill="#888888"
                                                        d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z" />
                                                </svg></a>
                                            <a href="{{ !empty(get_social_links()) ? get_social_links()->linkedin_links : '' }}"
                                                title="linkedin" data-toggle="tooltip" data-placement="top"><i
                                                    class="fab fa-linkedin" aria-hidden="true"></i></a>
                                            <a href="{{ !empty(get_social_links()) ? get_social_links()->instagram_links : '' }}"
                                                title="instagram" data-toggle="tooltip" data-placement="top"><i
                                                    class="fab fa-instagram"></i></a>
                                            <a href="{{ !empty(get_social_links()) ? get_social_links()->youtube_links : '' }}"
                                                title="youtube" data-toggle="tooltip" data-placement="top"><i
